    ...
    <Paper className={classes.jobTileOuter} elevation={3} style={{backgroundColor:"#94c39b"}}>
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          <Grid item>
            <Typography style={{fontFamily:"garamond",fontSize:"35px",color:"#0D4008"}}>
...
const AcceptedApplicants = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography style={{fontFamily:"garamond",fontSize:"55px",color:"#0D4008"}}>Employees</Typography>
        </Grid>
        <Grid item>
        ...
        >
          {applications.length > 0 ? (
            ...
            <Typography style={{fontFamily:"garamond",fontSize:"35px",textAlign: "center"}} >
